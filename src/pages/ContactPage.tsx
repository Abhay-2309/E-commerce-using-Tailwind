            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@shopmodern.com</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                answer: "Yes, we ship to over 25 countries worldwide. International shipping times vary by location (5-14 business days)."
              },
              {
